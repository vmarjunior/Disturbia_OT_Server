...
monster.loot = {
	...
	{name = "dragonbone staff", chance = 210},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -70, maxDamage = -140, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -110, maxDamage = -170, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}
